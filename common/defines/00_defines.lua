...
NDiplomacy = {
	...
	TENSION_DECAY = 0.05,							-- Each months tension decays this much
	...
	IDEOLOGY_JOIN_FACTION_MIN_LEVEL = 0.1,			-- ideology limit required to join faction
...
NCountry = {
	...
	NUCLEAR_PRODUCTION_SCALE = 730,					-- +1 nuclear_production gives 1 nuke per year
...
NBuildings = {
	...
	ROCKETSITE_CAPACITY_MULT = 10,		-- Each level of rocketsite building multiplied by this, gives capacity (max operational value). Value is int. 1 for each rocket.
...
NMilitary = {
	...
	BASE_LEADER_TRAIT_GAIN_XP = 0.75,			   -- Base xp gain for traits per hour for armies
	...
	STRATEGIC_SPEED_INFRA_MAX = 15.0,               -- Additional speed of strategic redeployment on max-level infrastructure
...
NAir = {
	...
	STRATEGIC_BOMBER_NUKE_AIR_SUPERIORITY = 0.85,		-- How much air superiority is needed for a tactical bomber to be able to nuke a province
...
NAI = {
	...
	DIPLOMACY_FACTION_SAME_IDEOLOGY_MAJOR = 25, -- AI bonus acceptance when being asked about faction is a major of the same ideology
	...
	DECLARE_WAR_RELATIVE_FORCE_FACTOR = 0.4,	-- Weight of relative force between nations that consider going to war
	...
	DECLARE_WAR_NOT_NEIGHBOR_FACTOR = 0.8,		-- Multiplier applied before force factor if country is not neighbor with the one it is considering going to war
	...
	JOIN_ALLY_BASE_DESIRE = 15,					-- exactly what it says
	...
	GENERATE_WARGOAL_THREAT_BASELINE = 0.7,	    -- The baseline for what the AI considers the world is getting dangerous and we want to generate wargoals with no antagonize value
	...
	FORCE_FACTOR_AGAINST_EXTRA_MINOR = 0.3,			-- AI considers generating wargoals against minors below this % of force compared to themselves to get at a bigger enemy.
...
NIntel = {
	...
	RECON_PLANE_INTEL_BASE = 0.2, 				-- intel base amount for a strategic area per plane
